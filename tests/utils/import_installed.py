...
def import_installed(module_name):
    ...
    Example usage, e.g. in a client_end2end_tester test program::

        from ...utils import import_installed
        client_end2end_tester = import_installed('client_end2end_tester')  # pylint: disable=invalid-name
        from client_end2end_tester import ...
