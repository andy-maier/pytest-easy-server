...
.. code-block:: bash
    ...
    $ pip download --no-deps --no-binary :all: client_end2end_tester==1.0.0
    $ tar -xf client_end2end_tester-1.0.0.tar.gz
    $ cd client_end2end_tester-1.0.0
    $ ls -1
    ...
    drwxr-xr-x  29 johndoe  staff    928 Jul  3 07:55 client_end2end_tester
    drwxr-xr-x   8 johndoe  staff    256 Jul  3 07:55 client_end2end_tester.egg-info
