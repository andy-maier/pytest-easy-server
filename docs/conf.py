...
"""
Sphinx config file for pytest-easy-server project.
...
version = get_version(os.path.join('..', 'pytest_easy_server', '_version.py'))
...
htmlhelp_basename = 'pytest-easy-server_doc'
...
latex_documents = [
    (master_doc, 'pytest-easy-server.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pytest-easy-server', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytest-easy-server', _short_description,
     author, 'pytest-easy-server', _short_description,
     'Miscellaneous'),
]
