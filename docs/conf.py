...
"""
Sphinx config file for pytest-tars project.
...
version = get_version(os.path.join('..', 'pytest_tars', '_version.py'))
...
htmlhelp_basename = 'pytest-tars_doc'
...
latex_documents = [
    (master_doc, 'pytest-tars.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pytest-tars', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytest-tars', _short_description,
     author, 'pytest-tars', _short_description,
     'Miscellaneous'),
]
        ...
        try:
            ...
            if 'methods' in self.options:
                ...
                for method in methods:
                    ...
                    if def_module_name.startswith('pytest_tars'):
